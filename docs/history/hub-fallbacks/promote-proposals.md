...
- **(a) Delivery draft** — not applied. `docs/knowledge/work/hub-fallbacks/delivery.md`
  already exists as a curated record.
- **(b) Area updates** — not applied. `docs/specs/bee-cockpit.md` names `hub-fallbacks` in its own
