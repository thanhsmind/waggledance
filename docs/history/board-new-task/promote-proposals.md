...
- **(a) Delivery draft** — not applied. `docs/knowledge/work/board-new-task/delivery.md`
  already exists as a curated record.
- **(b) Area updates** — not applied. `docs/specs/bee-cockpit.md` names `board-new-task` in its own
