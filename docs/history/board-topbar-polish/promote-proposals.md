...
- **(a) Delivery draft** — not applied. `docs/knowledge/work/board-topbar-polish/delivery.md`
  already exists as a curated record.
- **(b) Area updates** — not applied. `docs/specs/bee-cockpit.md` names `board-topbar-polish` in its own
