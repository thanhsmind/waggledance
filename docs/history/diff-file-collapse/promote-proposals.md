promote proposal for work item "diff-file-collapse" (docs/history/diff-file-collapse/CONTEXT.md) — 1 capped cell(s): dfc-1
anchor: history — docs/history/diff-file-collapse/CONTEXT.md
PROPOSAL ONLY — nothing was written. Applying any section below is a human or agent decision.

(a) DELIVERY DRAFT — save as docs/knowledge/work/diff-file-collapse/delivery.md
