...
- **(a) Delivery draft** — not applied. `docs/knowledge/work/archive-visibility/delivery.md`
  already exists as a curated record.
- **(b) Area updates** — not applied. `docs/specs/bee-cockpit.md` names `archive-visibility` in its own
