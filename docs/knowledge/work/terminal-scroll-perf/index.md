...
# work/terminal-scroll-perf/

## Concepts

- [terminal-scroll-perf — delivery](delivery.md) — Delivery record for work item terminal-scroll-perf: 1 capped cell(s), 0 recorded deviation(s).
