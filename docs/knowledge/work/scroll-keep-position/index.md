...
# work/scroll-keep-position/

## Concepts

- [scroll-keep-position — delivery](delivery.md) — Delivery record for work item scroll-keep-position: 3 capped cell(s), 0 recorded deviation(s).
