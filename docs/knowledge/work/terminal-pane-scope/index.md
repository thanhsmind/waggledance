...
# work/terminal-pane-scope/

## Concepts

- [terminal-pane-scope — delivery](delivery.md) — Delivery record for work item terminal-pane-scope: 4 capped cell(s), 0 recorded deviation(s).
