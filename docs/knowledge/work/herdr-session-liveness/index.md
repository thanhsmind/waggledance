...
# work/herdr-session-liveness/

## Concepts

- [herdr-session-liveness — delivery](delivery.md) — Delivery record for work item herdr-session-liveness: 1 capped cell(s), 0 recorded deviation(s).
